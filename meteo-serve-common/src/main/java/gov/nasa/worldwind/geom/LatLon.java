/*
 * modify from worldwind 2014-10-27 db_x
 */
...
public class LatLon
{
    ...
    public LatLon(Angle latitude, Angle longitude)
    {
        ...
        {
            throw new IllegalArgumentException("nullValue.LatitudeOrLongitudeIsNull");
        }
    ...
    public LatLon(LatLon latLon)
    {
        if (latLon == null)
        {
            throw new IllegalArgumentException("nullValue.LatLonIsNull");
        }
    ...
    public static LatLon[] greatCircleExtremeLocations(LatLon location, Angle azimuth)
    {
        if (location == null)
        {
            throw new IllegalArgumentException("nullValue.LocationIsNull");
        }
    ...
    public static Angle getAverageDistance(Iterable<? extends LatLon> locations)
    {
        ...
        if ((locations == null))
        {
            throw new IllegalArgumentException("nullValue.LocationsListIsNull");
        }
    ...
    public LatLon parseLatLon(String latLonString) // TODO
    {
        ...
        {
            throw new IllegalArgumentException("nullValue.StringIsNull");
        }
	...
	public static boolean locationsCrossPrimeMeridian(LatLon pos0, LatLon pos1) {
