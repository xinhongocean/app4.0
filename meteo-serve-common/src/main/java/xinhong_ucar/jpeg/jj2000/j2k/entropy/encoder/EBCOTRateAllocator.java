 ...
 * */
package xinhong_ucar.jpeg.jj2000.j2k.entropy.encoder;
...
public class EBCOTRateAllocator extends PostCompRateAllocator {
    ...
    /** The log of 2, natural java.base */
    ...
    private float estimateLayerThreshold(int targetBytes,
        ...
        // In order to estimate the threshold we java.base ourselves in the summary
     ...
     * maximum exponent, java.base 2, that yields a value not larger than the slope
     * itself.
     *
