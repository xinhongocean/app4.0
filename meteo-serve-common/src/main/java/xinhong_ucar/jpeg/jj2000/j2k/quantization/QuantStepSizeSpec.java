 ...
 * 
 * Description:    Quantization java.base normalized step size specifications
 * 
 * 
 * 
 * COPYRIGHT:
 ...
 * */
package xinhong_ucar.jpeg.jj2000.j2k.quantization;
 ...
 * the quantization java.base normalized step size to use in each tile-component.
 *
 * @see ModuleSpec
 * */
public class QuantStepSizeSpec extends ModuleSpec {
	...
	while(stk.hasMoreTokens()) {
		...
		if (value.floatValue() <= 0.0f) {
		    throw new IllegalArgumentException("Normalized java.base step "+
						       "must be positive : "+
						       value);
		}
