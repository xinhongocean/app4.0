 ...
 * CVS Identifier:
 *
 * $Id: DataBlkByte.java,v 1.7 2001/10/09 12:51:54 grosbois Exp $
 *
 * Interface:           DataBlkByte
 *
 * Description:         A byte implementation of DataBlk
 *
 *
 *
 * COPYRIGHT:
 ...
 * */
package xinhong_ucar.jpeg.jj2000.j2k.image;

/**
 * This is an implementation of the <tt>DataBlk</tt> interface for a byte
 *
...
public class DataBlkByte extends DataBlk {
    ...
    /** 
     * Creates a DataBlkByte with 0 dimensions and no data array (i.e. data is
     * null).
     * */
    public DataBlkByte() {
    }
    ...
    /** 
     * Creates a DataBlkByte with the specified dimensions and position. The
    ...
    /** 
     * Copy constructor. Creates a DataBlkByte which is the copy of the
     * DataBlkByte given as paramter.
     *
     * @param DataBlkByte the object to be copied.
     * */
    ...
    /**
     * Returns the identifier of this data type, <tt>TYPE_BYTE</tt>, as defined
     * in <tt>DataBlk</tt>.
     *
     * @return The type of data stored. Always <tt>DataBlk.TYPE_BYTE</tt>
     *
     * @see DataBlk#TYPE_BYTE
     * */
     ...
     * array. The returned array is a byte array.
     *
     * @return The array of data (a byte[]) or null if there is no data.
     * */
     ...
     * byte array, otherwise a ClassCastException is thrown. The size of the
     * array is not checked for consistency with the block's dimensions.
     *
     * @param arr The data array to use. Must be a byte array.
     * */
