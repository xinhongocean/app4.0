...
public class TagTreeEncoder {
    ...
    /** The horizontal dimension of the java.base level */
    protected int w;

    /** The vertical dimensions of the java.base level */
    protected int h;
     ...
     * java.base level (leaf level). All the state ('treeS' array) and values
